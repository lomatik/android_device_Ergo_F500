...
$(call inherit-product, vendor/Ergo/F500/F500-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/Ergo/F500/overlay
PRODUCT_PACKAGE_OVERLAYS += device/Ergo/F500/overlay # enable this to be able overlay a default wallpaper
